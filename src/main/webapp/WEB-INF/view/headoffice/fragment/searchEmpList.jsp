			           	    ...
			           	    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12" style="margin-bottom:15px;">
			                	<div class="student-inner-std res-mg-b-30">
			                     <div class="student-img">
			                        <img src="https://gdhealth.s3.ap-southeast-2.amazonaws.com/employee/${m.filename}" style="height:300px; width:300px;"/>
			                     </div>
	             ...
	             <ul class="pagination">   	
				    ...
				    <c:forEach begin="${startPageNum}" end="${endPageNum}" var="pageNum">
					  	...
					  	<c:if test="${pageNum != currentPage}"> <!-- 페이지네이션 버튼 색 변경x --> 
					  		<li class="page-item">
						  		<a class="page-link searchPageBtn" href="#" 
						  		data-page="${pageNum}" data-type="${type}" data-keyword="${keyword}">${pageNum}</a>
						  	</li>
					  	</c:if>
				    </c:forEach>
				    <!------- 페이지 번호 버튼 end ------->
				    ...
				    <!------- '다음' 버튼 start ------->
			  		<c:if test="${next}">
					  	<li class="page-item searchPageBtn"><a class="page-link" href="#" data-page="${endPageNum + 1}" 
					  				data-type="${type}" data-keyword="${keyword}">다음</a></li>
				 	</c:if>
				 	<!------- '다음' 버튼 end ------->
