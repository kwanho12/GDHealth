...
public class EmpController {
	...
	public String getPagination(Model model, int page) {
		...
		List<Map<String, Object>> empList = empService.getEmployeeList(pagination.getBeginRow(), pagination.getRowPerPage());
	...
	public String getSearchPagination(Model model, String type, String keyword, int page) {
		...
		List<Map<String, Object>> searchList = empService.getSearchList(pagination.getBeginRow(), pagination.getRowPerPage(),
				type, keyword);
	...
	public int checkExistingId(String employeeId) {
		...
		int result = empService.getIsIdExists(employeeId);
